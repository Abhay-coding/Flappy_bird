...
class Agent:
    ...
    def run(self, is_training=True, render=False):
        ...
        for episode in itertools.count():
            ...
            while (not terminated and episode_reward < self.reward_threshold):
                ...
                state = next_state
            if episode_reward > 0 or episode % 1000 == 0:   
                if is_training:
            ...
            # ✅ PLOT graph every 1000 episodes
            if is_training and episode % 1000 == 0 and episode > 0:
    ...
    def plot_rewards(self, rewards):
        ...
        plt.savefig(os.path.join(RUNS_DIR, f"{self.param_set}_plot.png"))
        plt.close()
